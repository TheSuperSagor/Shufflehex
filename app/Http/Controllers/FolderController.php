...
class FolderController extends Controller
{
    ...
    public function show($id)
    {
        $folderStories = DB::table('folders')
            ...
            ->where('folders.id', '=', $id)
            ->select('saved_stories.id as saved_id','saved_stories.user_id','saved_stories.post_id','saved_stories.folder_id','posts.title','posts.featured_image','folders.folder_name')
            ->get();
//        dd($folderStories);
