...
@section('css')
    ...
    <link rel="stylesheet/less" href="{{ asset('ChangedDesign/lessFiles/less/project.less') }}">
...
$product->tagline = "This is tagline short description";
$product->category = "GOOGLE, TECH";
    ...
    <div class="box project">
        <div class="project-box">
        	<div class="row project-title">
        	    <div class="logo">
                    <img class="original" src="https://www.jqueryscript.net/demo/Feature-rich-Product-Gallery-With-Image-Zoom-xZoom/images/gallery/original/01_b_car.jpg"/>
        	    </div>
            ...
            <div class="row">
                <div class="col-md-12 project-media">
                    <img class="xzoom original" src="https://www.jqueryscript.net/demo/Feature-rich-Product-Gallery-With-Image-Zoom-xZoom/images/gallery/original/01_b_car.jpg"
            ...
            <div class="row">
            	<div class="col-md-12 project-review">
