            ...
            <div class="box">
                ...
                <div class="folder-item">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-3 dis-n pl-38">
                            <a class="btn btn-danger btn-sm" onclick="deleteFolder({{ $folder->id }})"><i class="fa fa-trash"></i> Delete</a>
                            <a class="btn btn-default btn-sm " data-toggle="modal" data-target="#editFolderModal" onclick="renameFolder({{ $folder->id }})"><i class="fa fa-pencil"></i> Rename</a>
                        ...
                        <div class="col-md-4 col-xs-3 dis-show plr-0">
                            <a class="btn btn-danger btn-sm" onclick="deleteFolder({{ $folder->id }})"><i class="fa fa-trash"></i> </a>
